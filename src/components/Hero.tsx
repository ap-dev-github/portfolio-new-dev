        ...
        >
          ...
          <div>
            ...
            <div className="text-2xl md:text-4xl font-light text-slate-400 font-display leading-snug">
              ...
              optimized for low operational cost and real-world scale
            </div>
          </div>

          {/* Summary */}
          <p className="max-w-2xl text-lg text-slate-400 leading-relaxed border-l-2 border-slate-800 pl-6">
            I design and ship production-grade SaaS platforms end-to-end —
            from edge security and backend orchestration to AI-assisted pipelines.
            My work focuses on correctness, explainability, and long-term maintainability,
