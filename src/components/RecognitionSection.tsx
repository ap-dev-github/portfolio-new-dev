    ...
    <section className="py-24 px-6 max-w-7xl mx-auto border-t border-white/5">
      <div className="grid lg:grid-cols-12 gap-12">
        ...
        <div className="lg:col-span-5 flex flex-col justify-center">
          ...
          <div className="mt-8 p-6 rounded-3xl bg-blue-500/5 border border-dashed border-blue-500/20">
            <div className="flex items-start gap-4">
              <Milestone className="text-blue-400 shrink-0" size={20} />
              <p className="text-[11px] text-slate-400 leading-relaxed italic">
                Awaiting final degree conferral from <span className="text-white font-bold">VIT-AP University</span> in June 2026. 
                Current CGPA: <span className="text-blue-400 font-bold">8.69</span>
              </p>
            </div>
          </div>
        </div>
